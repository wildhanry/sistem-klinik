            ...
            <div class="space-y-4">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="satuan" id="satuan" value="{{ old('satuan') }}" placeholder="Contoh: tablet, botol, strip" required
                    ...
                    <div>
                        <label for="stok" class="block text-sm font-medium text-gray-300 mb-2">Stok Awal</label>
