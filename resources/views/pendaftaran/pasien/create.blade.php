        ...
        <form action="{{ route('pendaftaran.pasien.store') }}" method="POST">
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <input type="text" name="no_rekam_medis" id="no_rekam_medis" value="{{ old('no_rekam_medis') }}" required
                ...
                <div>
                    ...
                    <textarea name="alamat" id="alamat" rows="3" required
                        class="w-full px-4 py-2 bg-gray-700 border border-gray-600 text-white rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent @error('alamat') border-red-500 @enderror">{{ old('alamat') }}</textarea>
                    @error('alamat')
                        <p class="text-red-400 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
